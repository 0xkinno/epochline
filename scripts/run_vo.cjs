...
const pyScript = `import asyncio, edge_tts, os, subprocess, json
...
fs.writeFileSync('scripts/make_voiceover.py', pyScript, 'utf8');
const p = spawn('python', ['scripts/make_voiceover.py'], { stdio: 'inherit' });
